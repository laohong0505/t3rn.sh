...
function execute_script() {
    ...
    wget https://github.com/t3rn/executor-release/releases/download/v0.31.0/executor-linux-v0.29.0.tar.gz
    ...
    export RPC_ENDPOINTS_ARBT='xxxxx'
    export RPC_ENDPOINTS_OPSP='xxxxx'
